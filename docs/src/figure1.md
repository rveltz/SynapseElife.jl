...
The goal of this page is to reproduce the Figure 1 in [BiorXiv](https://www.biorxiv.org/content/10.1101/2021.03.30.437703v1). Note that this is essentially the file in `example/Figure1.jl`. 
